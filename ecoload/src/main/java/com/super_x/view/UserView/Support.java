    ...
    private void loadSampleTickets() {
        ...
        submittedTickets.add(
                new SupportTicket(
                        ...
                        "Payment for the completed trip has not "
                                + "been reflected in my account.",
                        "In Progress",
        ...
        submittedTickets.add(
                new SupportTicket(
                        ...
                        "My completed trip is still showing "
                                + "an incorrect status.",
                        "In Progress",
        ...
        submittedTickets.add(
                new SupportTicket(
                        ...
                        "The required document could not be uploaded "
        ...
        submittedTickets.add(
                new SupportTicket(
                        ...
                        "Dashboard information was taking too long "
                                + "to load after login.",
                        "Resolved",
