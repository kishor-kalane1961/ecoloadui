...
public class Ratings {
    ...
    private VBox createCustomerReviewsPage() {
        ...
        reviews.getChildren().addAll(
                ...
                createReviewCard(
                        "Siddharth Sharma",
                        "Pune to Nashik • 14 Oct 2023",
                        "Driver arrived on time and handled the fragile "
                                + "electronics cargo with extreme care. "
                                + "Communication throughout the trip was excellent. "
                                + "Highly recommended for long-distance hauls!",
                        5),

                createReviewCard(
                        "Anjali Mehta",
                        "Mumbai to Bangalore • 12 Oct 2023",
                        "Efficient delivery. Ramesh was professional and "
                                + "understood the complex unloading requirements "
                                + "at our facility. The vehicle was clean and "
                                + "well-maintained.",
                        5),

                createReviewCard(
                        "Vikram Roy",
                        "Delhi to Jaipur • 08 Oct 2023",
                        "Smooth trip. A slight delay due to highway "
                                + "construction but the driver communicated it "
                                + "well in advance. Overall very satisfied "
                                + "with the service.",
                        5));
